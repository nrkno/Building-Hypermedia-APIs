REM Designing Hypermedia APIs by Mike Amundsen (2011) 
REM 2011-05.20 (mca) collection-data-tasks for couchdb
...
REM echo 'testing shows...'
REM curl -v -H accept:application/json http://localhost:5984/collection-data-tasks/_design/example/_show/tasks
REM echo '.'

REM echo 'testing validator...'
REM curl -vX PUT http://localhost:5984/collection-data-tasks/task2 -d @task1.json
